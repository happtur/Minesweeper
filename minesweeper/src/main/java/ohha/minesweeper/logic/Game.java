...
public class Game {
    ...
    /**
     * The method returns the size of the grid's axes. So if the grid's size
     * is 4*4, this method returns 4.
     *
     ...
     * two elements, where the first element is the x-coordinate and the
     * second the y-coordinate.
     *
     * @param xy string in the format "1:2", where 1 is the x-coordinate and
     ...
     * correspond to the parameters is flagged.
     *
     * @param x the x-coordinate of the tile
     * @param y the y-coordinate of the tile
     * 
